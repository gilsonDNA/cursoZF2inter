...
class Module
{
    ...
    public function init(ModuleManager $moduleManager){
        ...
        $sharedEvents->attach("Zend\Mvc\Controller\AbstractActionController", MvcEvent::EVENT_DISPATCH, 
    ...
    public function validaAuth($e)
    {
        ...
        if(!$auth->getIdentity() and ($matchedRoute == "sonuser-admin" or $matchedRoute == "sonuser-admin/paginator")){
